...
- PowerShell 5+ (Windows) або Bash (Linux/macOS)

### Windows

```powershell
# Дозволити виконання скриптів (одноразово)
...
|-----------------------------|:-----------:|------------------|-----------------------------------------|
| `DB_ROOT_PASSWORD`          | ✅ так      | —                | Пароль root для MariaDB                 |
| `DB_USERSTORYPROJ_USER`     | ні          | `userstorydb`    | Користувач бази даних застосунку        |
| `DB_USERSTORYPROJ_PASSWORD` | ✅ так      | —                | Пароль користувача бази даних           |
| `PROJECT_DIR`               | авто        | встановлює скрипт| Абсолютний шлях до кореня проекту       |
